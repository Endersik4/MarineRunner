...
public:
	...
	TSubclassOf<class USettingMenuEntryObject> MenuSettingsDataObject = nullptr;
...
private:
	...
	TObjectPtr<class USettingMenuEntryObject> ConnectedSettings(TObjectPtr < USettingMenuEntryObject> ObjectThatConnectOtherSettings, TObjectPtr < USettingMenuEntryObject> ConstructedItemObject);

	void ActiveSettingByType(const FMenuSettings& SubSettingData, TObjectPtr < USettingMenuEntryObject> SettingMenuObject);
